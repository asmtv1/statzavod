...
const en: Record<string, string> = {
	'Проверяем совместимость площадок.': 'Checking platform compatibility.', 'Исправьте несовместимые настройки площадок.': 'Fix incompatible platform settings.',
	'YouTube title': 'YouTube title', 'Cover frame': 'Cover frame', 'Open frame editor': 'Open frame editor', 'Assign alternate media': 'Assign alternate media',
	'TikTok settings': 'TikTok settings', 'TikTok privacy': 'TikTok privacy', 'Choose privacy': 'Choose privacy', 'Required': 'Required', 'Allow comments': 'Allow comments', 'Allow Duet': 'Allow Duet', 'Allow Stitch': 'Allow Stitch', 'I have explicit publishing consent': 'I have explicit publishing consent', 'Music usage confirmed': 'Music usage confirmed', 'Commercial disclosure confirmed': 'Commercial disclosure confirmed',
	'Выберите будущее время по Москве.': 'Choose a future Moscow time.', 'Заполните обязательные настройки TikTok.': 'Complete the required TikTok settings.', 'Есть несохранённые изменения. Закрыть черновик?': 'There are unsaved changes. Close the draft?', 'Действие выполнено.': 'Action completed.', 'Отправить на согласование': 'Submit for approval', 'Опубликовать': 'Publish', 'Отменить публикацию': 'Cancel publication',
	'Планирование': 'Planning', 'VK Видео': 'VK Video', 'Выберите вертикальное видео.': 'Choose a vertical video.',
	'Загружаем правила согласования…': 'Loading approval rules…', 'Согласование публикаций': 'Publication approval', 'Эти правила применяются только к действиям самого креатора. Действия менеджера и владельца определяются их правами.': 'These rules apply only to actions initiated by the creator. Manager and owner actions are determined by their permissions.',
	'Публикация требует согласования': 'Publishing requires approval', 'Изменение черновика требует согласования': 'Editing a draft requires approval', 'Отмена публикации требует согласования': 'Cancelling a publication requires approval',
	'Публикация больше недоступна.': 'This publication is no longer available.', 'У вас нет доступа к этой публикации.': 'You do not have access to this publication.', 'Черновик изменился в другом окне. Обновите данные и повторите действие.': 'The draft changed in another window. Refresh it and try again.', 'Для одной или нескольких площадок нужно переподключение.': 'One or more platforms need to be reconnected.', 'Не удалось выполнить действие с публикацией.': 'Could not complete the publication action.',
	'Выберите креатора.': 'Choose a creator.', 'Выберите хотя бы один аккаунт.': 'Choose at least one account.',
	'Не удалось загрузить часть видео.': 'Could not upload a video part.', 'Хранилище не вернуло ETag части.': 'Storage did not return a part ETag.',
	'Публикация запланирована.': 'Publication scheduled.', 'Черновик сохранён.': 'Draft saved.', 'Не удалось сохранить публикацию.': 'Could not save the publication.',
	'Планирование публикаций': 'Publication planning', 'Одно вертикальное видео — несколько площадок, отдельный результат для каждого аккаунта.': 'One vertical video, multiple platforms, and a separate result for every account.',
	'Новая публикация': 'New publication', 'Раздел публикаций': 'Publication section', 'Новый черновик': 'New draft', 'Черновики и расписание': 'Drafts and schedule',
	'Время указано по Москве': 'Times are shown in Moscow time', 'Список': 'List', 'Календарь': 'Calendar', 'целей': 'targets', 'Открыть публикацию': 'Open publication', 'Повторить выбранные ошибки': 'Retry selected failures', 'Создать копию': 'Create copy', 'История попыток': 'Attempt history', 'Скрыть историю': 'Hide history',
	'Выбрать для повтора': 'Select for retry', 'Выбрать все ошибки': 'Select all failed', 'Опубликованные': 'Published',
	'Согласование': 'Approval', 'Загрузить ещё': 'Load more',
	'Ревизия': 'Revision', 'Запланированных публикаций пока нет.': 'There are no scheduled publications yet.', 'Выберите креатора': 'Choose a creator',
	'Вертикальное видео': 'Vertical video', 'Файл загружается напрямую в приватное хранилище.': 'The file uploads directly to private storage.',
	'Общее описание': 'Shared description', 'Хештеги': 'Hashtags', 'Разделяйте пробелом или запятой.': 'Separate with spaces or commas.', '#статзавод #shorts': '#statzavod #shorts',
	'Опубликовать по московскому времени': 'Publish in Moscow time', 'Аккаунты площадок': 'Platform accounts', 'Сначала подключите аккаунты выбранного креатора.': 'Connect accounts for the selected creator first.',
	'Предпросмотр видео': 'Video preview', 'Описание появится здесь': 'The description will appear here', 'Запланировать': 'Schedule', 'Сохранить черновик': 'Save draft',
  ...
  'Меняем рабочий контекст…': 'Switching workspace context…', 'Рабочий контекст': 'Workspace context',
  'Нет доступных профилей': 'No profiles are available', 'Нет назначенных компаний': 'No companies are assigned',
  'Контекст больше недоступен. Выберите другой.': 'This context is no longer available. Choose another.',
  'Владелец': 'Owner', 'Менеджер': 'Manager', 'Команда': 'Team', 'Аудит': 'Audit',
  'Мои соцсети': 'My social accounts', 'Моя статистика': 'My statistics', 'Основная навигация': 'Primary navigation',
  'Мои аккаунты': 'My accounts', 'ЛИЧНЫЙ КАБИНЕТ': 'PERSONAL PORTAL', 'ЛИЧНАЯ АНАЛИТИКА': 'PERSONAL ANALYTICS',
  'Нет назначенных профилей': 'No profiles are assigned', 'Обратитесь к владельцу рабочего пространства, чтобы получить доступ к профилю креатора.': 'Ask the workspace owner to grant access to a creator profile.',
  'Профиль недоступен': 'Profile unavailable', 'Загружаем профиль…': 'Loading profile…', 'Только ваши назначенные аккаунты и данные для входа. Изменения выполняет менеджер.': 'Only your assigned accounts and sign-in details. Changes are made by a manager.',
  'Комментариев по работе пока нет.': 'There are no work comments yet.', 'Архивирован': 'Archived', 'Неактивен': 'Inactive', 'Профиль архивирован': 'Profile archived',
  'Доступ к данным этого профиля закрыт. Выберите другой профиль в меню, если он вам назначен.': 'Access to this profile is closed. Choose another assigned profile in the menu.',
  'Подключённые соцсети': 'Connected social accounts', 'Список доступен только для просмотра.': 'This list is read-only.', 'Загружаем аккаунты…': 'Loading accounts…', 'Обновлено:': 'Updated:',
  'К этому профилю ещё не подключены соцсети.': 'No social accounts are connected to this profile yet.', 'Данные доступа': 'Access details',
  'Секретные значения скрыты, пока вы сами не откроете их.': 'Secret values remain hidden until you reveal them.', 'Загружаем данные…': 'Loading details…',
  'Данные доступа пока не добавлены.': 'Access details have not been added yet.', 'Не удалось показать пароль': 'Could not reveal the password', 'Не удалось скопировать значение': 'Could not copy the value',
  'Не удалось подготовить Excel': 'Could not prepare the Excel file', 'Статистика появится после назначения профиля креатора.': 'Statistics will appear after a creator profile is assigned.',
  'Копировать': 'Copy', 'Площадки': 'Platforms',
  'Статистика только по активному профилю в переключателе слева.': 'Statistics are only for the active profile in the left switcher.',
  'Выберите профиль и период': 'Choose a profile and period', 'Для аналитики нужен активный профиль креатора и корректный диапазон дат.': 'Analytics needs an active creator profile and a valid date range.',
  'Не удалось загрузить статистику': 'Could not load statistics', 'Собираем статистику…': 'Collecting statistics…', 'За выбранный период публикаций нет': 'There are no publications in the selected period',
  'Попробуйте изменить период или дождитесь следующей синхронизации.': 'Try another period or wait for the next synchronization.', 'Результат публикаций активного профиля за выбранный период.': 'Results for publications from the active profile in the selected period.',
  'Открыть меню': 'Open menu', 'Закрыть меню': 'Close menu', 'Выберите компанию': 'Choose a company',
  'Доступ уже настроен. Данные раздела появятся на следующем этапе.': 'Access is configured. This section’s data will be added in the next stage.',
  ...
  'Токен истёк': 'The token has expired',
  ...
  'Переподключить проблемные': 'Reconnect problematic accounts', 'Аккаунты креаторов': 'Creator accounts', 'Ошибки подключений и синхронизации показываются первыми.': 'Connection and synchronization errors are shown first.',
  ...
  'Ставим в очередь…': 'Queuing…', 'Синхронизация запрошена': 'Synchronization requested', 'Синхронизировать сейчас': 'Synchronize now', 'Синхронизация выполняется…': 'Synchronization in progress…', 'Синхронизировано': 'Synchronized', 'Повторить синхронизацию': 'Retry synchronization', 'Синхронизация завершилась с ошибкой.': 'Synchronization failed.', 'Синхронизация не завершилась за две минуты. Проверьте состояние worker.': 'Synchronization did not finish within two minutes. Check the worker status.', 'Данные общего доступа для команды': 'Shared access details for the team', 'Логин и пароль': 'Login and password', 'Только номер телефона': 'Phone number only',
  ...
  'креатор': 'creator', 'креаторов': 'creators', 'с ошибками синхронизации': 'with synchronization failures', 'Токен до': 'Token until', 'Задач ожидает': 'Pending tasks',
  ...
  'Загружаем доступы…': 'Loading access details…', 'Загружаем карточку креатора…': 'Loading creator profile…', 'Загружаем подключения…': 'Loading connections…', 'Закрыть уведомление': 'Close notification', 'Уведомления': 'Notifications', 'Центр уведомлений': 'Notification center', 'непрочитанных уведомлений': 'unread notifications', 'Нужно согласование публикации': 'Publication approval needed', 'Решение по публикации': 'Publication decision', 'Требуется переподключение аккаунта': 'Account reconnection required', 'Публикация завершилась ошибкой': 'Publication failed', 'Публикация выполнена': 'Publication completed',
  ...
  'Настройки аккаунта': 'Account settings', 'БЕЗОПАСНОСТЬ АККАУНТА': 'ACCOUNT SECURITY', 'Удаление аккаунта': 'Account deletion', 'Рассчитываем последствия…': 'Calculating impact…',
  'Вы — единственный владелец. Аккаунт, рабочая зона и все данные будут удалены без 90-дневного ожидания. Доступ всех пользователей прекратится сразу.': 'You are the sole owner. The account, workspace, and all data will be deleted without the 90-day delay. Access for every user ends immediately.',
  'В рабочей зоне останется другой владелец. Будет удалён только ваш аккаунт и его сессии; компании и бизнес-данные сохранятся.': 'Another owner will remain. Only your account and sessions will be deleted; companies and business data will be preserved.',
  'Пользователи': 'Users', 'Текущий пароль': 'Current password', 'Подтвердите текущий email': 'Confirm current email', 'Введите адрес полностью': 'Enter the full address',
  'Удалить рабочую зону и аккаунт': 'Delete workspace and account', 'Удалить мой аккаунт': 'Delete my account', 'УДАЛЕНИЕ ПОДТВЕРЖДЕНО': 'DELETION CONFIRMED', 'Рабочая зона удаляется': 'Workspace deletion is in progress', 'Аккаунт удалён': 'Account deleted',
  'Доступ уже закрыт. Система завершает локальное удаление данных и отзыв подключений.': 'Access is already closed. The system is completing local data deletion and connection revocation.', 'Ваши сессии закрыты. Данные рабочей зоны остаются у других владельцев.': 'Your sessions are closed. Workspace data remains with the other owners.', 'Номер операции': 'Operation ID', 'На главную': 'Back to home',
  'Загружаем архив…': 'Loading archive…', 'Архив компаний пуст.': 'The company archive is empty.', 'Архивирована': 'Archived', 'Автоматическое удаление': 'Automatic deletion', 'осталось дней:': 'days remaining:', 'Раздел компаний': 'Company section', 'Активные': 'Active',
  'Компания и связанные данные останутся в архиве 90 дней. Креаторы не отсоединяются от компании и вернутся вместе с ней после восстановления.': 'The company and related data will remain archived for 90 days. Creators stay attached and return with the company after restoration.',
  'Аккаунт личного кабинета': 'Portal account', 'Создайте новый вход или свяжите существующий аккаунт креатора по email.': 'Create a new sign-in or link an existing creator account by email.', 'Управлять аккаунтом': 'Manage account', 'Подключить аккаунт': 'Link account', 'Загружаем аккаунт…': 'Loading account…',
  'Новый общий пароль': 'New shared password', 'Начальный пароль': 'Initial password', 'Оставьте пустым, чтобы не менять': 'Leave blank to keep it unchanged', 'Менеджер не может сбрасывать пароль существующего аккаунта.': 'A manager cannot reset an existing account password.', 'Сбросить пароль': 'Reset password', 'Связать аккаунт': 'Link account', 'Заблокирован': 'Suspended', 'Аккаунт для входа ещё не связан.': 'No sign-in account is linked yet.',
  'Сначала выберите компанию в рабочем контексте': 'Select a company in the workspace context first', 'Чтобы создать креатора, выберите активную компанию в меню слева.': 'To create a creator, select an active company in the left menu.', 'Компания недоступна': 'Company unavailable',
  'БЕЗ СЕКРЕТОВ': 'NO SECRETS', 'Действия пользователей и системы. Чувствительные значения удаляются до сохранения записи.': 'User and system actions. Sensitive values are removed before a record is stored.', 'Фильтры аудита': 'Audit filters', 'Пользователь': 'User', 'Действие': 'Action', 'Ресурс': 'Resource', 'С даты': 'From date', 'По дату': 'To date', 'Загружаем аудит…': 'Loading audit…', 'Время': 'Time', 'Удалённый пользователь': 'Deleted user', 'Архивная компания': 'Archived company', 'Детали': 'Details', 'Назад': 'Back', 'Далее': 'Next', 'Детали события': 'Event details', 'Маршрут': 'Route', 'Ответ': 'Response', 'Метаданные': 'Metadata',
  'Просмотр статистики': 'View statistics', 'Экспорт статистики': 'Export statistics', 'Создание креаторов': 'Create creators', 'Редактирование креаторов': 'Edit creators', 'Архивирование креаторов': 'Archive creators', 'Удаление креаторов': 'Delete creators', 'Подключение соцсетей': 'Connect socials', 'Управление синхронизацией': 'Manage synchronization', 'Редактирование доступов': 'Edit credentials', 'Просмотр секретов': 'Reveal secrets',
  'УПРАВЛЕНИЕ ДОСТУПОМ': 'ACCESS MANAGEMENT', 'Владельцы и менеджеры рабочей зоны, их статус и доступ к компаниям.': 'Workspace owners and managers, their status, and company access.', 'Создать пользователя': 'Create user', 'Загружаем команду…': 'Loading team…', 'Не удалось загрузить команду': 'Could not load the team', 'Роль': 'Role', 'Действия': 'Actions', 'Недоступная компания': 'Unavailable company', 'Нет назначений': 'No assignments', 'Права': 'Permissions', 'Блокировать': 'Suspend', 'Разблокировать': 'Reactivate', 'Удалить пользователя': 'Delete user',
  'Новый пользователь': 'New user', 'Аккаунт создаётся сразу. Менеджеру можно выдать права после создания.': 'The account is created immediately. Manager permissions can be assigned afterward.', 'Создать': 'Create', 'Изменить email': 'Change email', 'Заблокировать пользователя': 'Suspend user', 'Разблокировать пользователя': 'Reactivate user', 'Бизнес-данные сохранятся, а все сессии пользователя будут отозваны.': 'Business data will be preserved and all user sessions will be revoked.', 'Изменение статуса немедленно отзывает все сессии.': 'Changing status immediately revokes every session.', 'Подтвердить': 'Confirm',
  'Загружаем права…': 'Loading permissions…', 'Не удалось загрузить права': 'Could not load permissions', 'Пользователь не найден': 'User not found', 'АТОМАРНАЯ МАТРИЦА': 'ATOMIC MATRIX', 'Права менеджера': 'Manager permissions', 'Сохранить права': 'Save permissions', 'Назначение компании даёт просмотр компании и карточек. Каждое дополнительное действие включается отдельно.': 'A company assignment grants access to the company and creator profiles. Every additional action is enabled separately.',
}
